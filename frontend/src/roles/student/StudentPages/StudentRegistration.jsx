...
>
    <div style={{  width: '100%',maxWidth: 800, margin: 'auto', padding: '40px', background: '#f7f7f7', borderRadius: '10px', boxShadow: '0 0 10px rgba(0,0,0,0.1)'}}>
      <h2 style={{ textAlign: 'center', color: '#1890ff', fontWeight:'bold' }}>Student Registration Form</h2>
