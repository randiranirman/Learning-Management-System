...
import { getStudentDetails } from "../../../utils/studentService";
...
const StudentSettings = () => {
  ...
  const handleProfileUpdate = (updatedData) => {
    setStudentDetails({ ...studentDetails, ...updatedData });
  };
            ...
            <Space direction="vertical" size="middle" style={{ width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: '14px' }}>{studentDetails.email || 'Not provided'}</Text>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: '14px' }}>{studentDetails.contactNumber || 'Not provided'}</Text>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: '14px' }}>
                    {studentDetails.city || studentDetails.address || 'Not provided'}
                  </Text>
                </div>
              </div>
            </Space>
