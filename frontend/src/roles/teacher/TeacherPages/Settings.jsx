...
const Settings = () => {
  ...
  const fetchTeacherDetails = async () => {
    ...
    try {
      ...
      console.log("Teacher Details:", details);
    ...
    <div style={{ padding: '24px', background: token.colorBgLayout, minHeight: '100vh' }}>
            ...
            <Space direction="vertical" size="middle" style={{ width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: '14px' }}>{teacherDetails.email || 'Not provided'}</Text>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: '14px' }}>{teacherDetails.contactNumber || 'Not provided'}</Text>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: '14px' }}>
                    {teacherDetails.city || teacherDetails.address || 'Not provided'}
                  </Text>
                </div>
              </div>
            </Space>
      ...
      {showPasswordReset && (
        <PasswordResetModal 
          ...
          userEmail={teacherDetails.email}
        />
      )}
